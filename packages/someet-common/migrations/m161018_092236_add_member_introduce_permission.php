...
class m161018_092236_add_member_introduce_permission extends Migration
{
    public function up()
    {
        $items = [
            '/mobile/member/introduce' => ['user'],
        ];
...
SQL;
    ...
    {
        echo "m161018_092236_add_member_introduce_permission cannot be reverted.\n";
