...
class m161216_073252_add_vip_rights_permission extends Migration
{
    public function up()
    {
        $items = [
            '/mobile/vip/rights' => ['user']
        ];
...
SQL;
    ...
    {
        echo "m161216_073252_add_vip_rights_permission cannot be reverted.\n";
