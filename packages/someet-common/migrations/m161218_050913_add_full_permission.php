...
class m161218_050913_add_full_permission extends Migration
{
    public function up()
    {
$items = [
            '/mobile/playground/add-apply-from' => ['user'],
        ];
...
SQL;
    ...
    {
        echo "m161218_050913_add_full_permission cannot be reverted.\n";
