...
class m161120_081944_add_wish_permission extends Migration
{
    public function up()
    {
        $items = [
        '/mobile/wish/wish-take' => ['user'],
        '/mobile/wish/finish' => ['user']
      ];
...
SQL;
    ...
    {
        echo "m161120_081944_add_wish_permission cannot be reverted.\n";
