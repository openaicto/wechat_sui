...
class m161025_074341_add_create_pay_error_permission extends Migration
{
    public function up()
    {

        $items = [
            '/mobile/pay/create-pay-error' => ['user'],
        ];
...
SQL;
    ...
    {
        echo "m161025_074341_add_create_pay_error_permission cannot be reverted.\n";
