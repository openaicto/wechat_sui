...
class m160831_110550_add_investigation_permission extends Migration
{
     public function up()
    {
    $items = [
            '/mobile/member/investigation' => ['user'],
            '/mobile/member/inve-finish' => ['user'],
        ];
...
SQL;
    ...
    {
        echo "m160831_110550_add_investigation_permission cannot be reverted.\n";
