...
class m161119_121006_add_wish_permission extends Migration
{
    public function up()
    {
        $items = [
        '/mobile/wish/index' => ['user'],
        '/mobile/wish/view' => ['user']
      ];
...
SQL;
    ...
    {
        echo "m161119_121006_add_wish_permission cannot be reverted.\n";
