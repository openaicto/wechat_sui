...
class m160919_114109_add_qrcode_page_permission extends Migration
{
    public function up()
    {
        $items = [
            '/mobile/vip/qrcode-view' => ['user'],
        ];
...
SQL;
    ...
    {
        echo "m160919_114109_add_qrcode_page_permission cannot be reverted.\n";
